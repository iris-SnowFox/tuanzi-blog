    ...
    <div class="bibi-chat-frame">
        ...
        <div class="center-list-frame" ref="charList">
            <div class="chat-list-frame">
                ...
                <ul class="chat-list">
                    <li v-for="list in chatListData" :key="list.id">
                        <img :src="list.avatar" alt="头像" v-lazy>
                        <div class="content">
        ...
        .chat-list-frame {
            ...
            .chat-list {
                ...
                li {
                    ...
                    &:hover {
                        background: rgba(255, 196, 169, 0.5);
                    }
